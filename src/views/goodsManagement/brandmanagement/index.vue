...
import { reqHasTrademark, reqAddOrUpdateTrademark, reqDeleteTrademark } from '@/apis/product/brand/index';
import type { Records, TradeMarkResponseData, TradeMark } from '@/apis/product/brand/type'
